...
void EntityProtocol::receive(int &socket, char **input) {

    socket.receive();
}

int EntityProtocol::getLen(char *input) {

}

void Message::writeChar(char* ptr, char num){
    ptr[0] = num;
}

void Message::writeInt(char* ptr, int num){
